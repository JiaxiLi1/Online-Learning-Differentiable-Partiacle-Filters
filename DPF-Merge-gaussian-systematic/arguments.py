...
def parse_args_maze(args=None):
    ...
    parser.add_argument('--dim', type=int, default=2, help='state dim')  # origin: 32, 24
    parser.add_argument('--batchsize', type=int, default=32, help='batch size') # origin: 32, 24
    parser.add_argument('--hiddensize', type=int, default=32, help='hidden size')  # origin: 32 for toy; 128 for maze
