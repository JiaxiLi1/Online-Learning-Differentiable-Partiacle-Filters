...
def get_model(args, parameter_input):
    if args.dataset == 'disk':
        model = DPF_disk(args)
    elif args.dataset =='maze':
        model = DPF_maze(args, parameter_input)
...
if __name__ == "__main__":
    ...
    parameter_input = [initial_loc, initial_scale, init_transition_mult, transition_scale, init_emission_mult, emission_scale, init_proposal_scale_0, init_proposal_scale_t]
    ...
    dpf = get_model(args, parameter_input)
