...
def parse_args(args=None, dataset='disk'):
    ...
    parser.add_argument('--num_dim', type=int, default=2, help='num exp')
    parser.add_argument('--trainType', type=str, default='pretrain', choices=['pretrain', 'online', 'supervised'], help='train type: supervised, semi, unsupervised learning')
    parser.add_argument('--labelled_ratio', type=float, default=1.0, help='labelled_ratio for supervised learning')
